    ...
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="name" value="Nome do Estabelecimento" />
                <jet-input id="name" type="text" class="mt-1 block w-full" v-model="form.nome" autocomplete="name" />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <jet-input id="descricao" type="text" class="mt-1 block w-full" v-model="form.descricao" />
