  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Serve para que seus clientes tenham acesso ao seu cardápio digital através de QR code, web e etc. Seu cardápio pode ser compartilhado em várias redes sociais, Facebook, Instagram e etc.
              </p>
            </a>
          </div>
        </div>
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Após fazer seu cardápio, basta compartilhar o link com seus clientes pelo Whatsapp, Instagram, Facebook e outras redes sociais.
              </p>
            </a>
          </div>
        </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <div class="flex justify-center ">
        <form method="POST" action="{{ route('register') }}" class="rounded p-2 bg-white opacity-75 border shadow text-black w-2/4">
            <ul class="mt-3 list-disc list-inside text-sm text-red-600">
              @foreach ($errors->all() as $message) 
                <li>{{ $message }}</li>
              @endforeach
